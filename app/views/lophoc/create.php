...
<section class="class-form">
    ...
    <form action="/lophoc/store" method="POST">
        <div class="form-group">
            ...
            <input type="text" name="tenlop" id="tenlop" placeholder="V&#237; d&#7909;: C&#244;ng ngh&#7879; th&#244;ng tin 68A" required>
        </div>

        <div class="form-group">
            <label for="malop">M&#227; l&#7899;p</label>
            <input type="text" name="malop" id="malop" placeholder="V&#237; d&#7909;: CNTT68A" required>
        </div>

        <div class="form-actions">
            <button type="submit" class="btn-submit">Th&#234;m l&#7899;p</button>
